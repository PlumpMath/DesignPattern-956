...
{
    public class IPhoneConcretePacker
    {
        private IPhone _iPhone;

        public IPhoneConcretePacker(IPhone iPhone)
        {
            this._iPhone = iPhone;
        }
...
#warning Terry: New code: Specify the concrete IPhone4, instead of abstract iPhone. It cannot adapt to changes.
            IPhone4 testIPhone = new IPhone4();
            AddAccessories(testIPhone, accessories);
