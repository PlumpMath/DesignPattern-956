...
{
    public sealed class LazyPrintService
    {
        ...
        private static LazyPrintService _printService;          // Different from Eager Mode
        ...
        public static LazyPrintService Instance
        {
            get
            {
                ...
                {
                    _printService = new LazyPrintService();     // Different from Eager Mode
                }
